...
# [MARKER] supplier 외(infrastructure) — 자료요청 기능 활성화용 수정. 최종작업 시 주석처리(소유자 적용 전제).
# _EXEMPT_ROLES = {"admin", "owner_esg", "owner_purchasing"}  # [MARKER] 원복 적용(영문 role은 비-supplier 자료요청 활성화용)
